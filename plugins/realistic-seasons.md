...
* /`toggleseasonparticles` - переключить сезонные партиклы. они могут выглядеть странно некоторыми с шейдерами
* `/togglefahrenheit` - переключение отображения температуры на фаренгейты
